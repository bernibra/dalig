...
setup(
    name = "dalig",
    version = "0.1",
    description = "dalig is directed graph alignment",
    author = "Daniel B. Stouffer",
    author_email = "daniel.stouffer@canterbury.ac.nz",
    url = 'http://github.com/stoufferlab/dalig',
    packages = ['dalig'],
    package_dir={'dalig':'src/python'},
    libraries = [dalig,], # note that this isn't actually a library (as defined by the build_clib hack above)
    cmdclass={'build_clib': build_clib,
              'config': config,
              'install_lib': install_lib,
              },
    scripts=['scripts/dalig','scripts/dalig.x'],
